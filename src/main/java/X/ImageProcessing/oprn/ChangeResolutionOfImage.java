...
public class ChangeResolutionOfImage {
	private static final Logger logger = LoggerFactory.getLogger(ChangeResolutionOfImage.class);
...
// USER-CODE-BLOCK BEGIN -- Do not modify anything outside this block or this comment line.
		...
		try {
			...
			// Mat source = Imgcodecs.imread("image.jpg", Imgcodecs.IMREAD_GRAYSCALE);
			...
			// Imgcodecs.imwrite("zoomed.jpg", destination);
