...
@WebServlet(urlPatterns="/x/imagewatermarking", name="Entry_x_imagewatermarking" )

public class Entry_x_imagewatermarking  extends HttpServlet  {

    private Workflow.RuntimeContext runtimeContext = null;
    private static final Logger log = LoggerFactory.getLogger(Entry_x_imagewatermarking.class);
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) {
        ...
        new Workflow(runtimeContext).executeWorkflow(new xsemble.controller.n.Node_InvokeWatermarking());
