...
@WebServlet(urlPatterns="/x/rotateimg", name="Entry_x_rotateimg" )

public class Entry_x_rotateimg  extends HttpServlet  {

    private Workflow.RuntimeContext runtimeContext = null;
    private static final Logger log = LoggerFactory.getLogger(Entry_x_rotateimg.class);
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) {
        ...
        new Workflow(runtimeContext).executeWorkflow(new xsemble.controller.n.Node_InvokeRotateImage());
