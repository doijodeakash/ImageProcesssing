...
@WebServlet(urlPatterns="/x/negativei", name="Entry_x_negativei" )

public class Entry_x_negativei  extends HttpServlet  {

    private Workflow.RuntimeContext runtimeContext = null;
    private static final Logger log = LoggerFactory.getLogger(Entry_x_negativei.class);
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) {
        ...
        new Workflow(runtimeContext).executeWorkflow(new xsemble.controller.n.Node_InvokeNegativeImage());
