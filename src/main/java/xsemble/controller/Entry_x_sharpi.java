...
@WebServlet(urlPatterns="/x/sharpi", name="Entry_x_sharpi" )

public class Entry_x_sharpi  extends HttpServlet  {

    private Workflow.RuntimeContext runtimeContext = null;
    private static final Logger log = LoggerFactory.getLogger(Entry_x_sharpi.class);
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) {
        ...
        new Workflow(runtimeContext).executeWorkflow(new xsemble.controller.n.Node_InvokeSharpenImage());
