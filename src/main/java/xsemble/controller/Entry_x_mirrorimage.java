...
@WebServlet(urlPatterns="/x/mirrorimage", name="Entry_x_mirrorimage" )

public class Entry_x_mirrorimage  extends HttpServlet  {

    private Workflow.RuntimeContext runtimeContext = null;
    private static final Logger log = LoggerFactory.getLogger(Entry_x_mirrorimage.class);
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) {
        ...
        new Workflow(runtimeContext).executeWorkflow(new xsemble.controller.n.Node_InvokeMirrorImage());
