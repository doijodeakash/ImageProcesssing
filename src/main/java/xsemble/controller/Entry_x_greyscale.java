...
@WebServlet(urlPatterns="/x/greyscale", name="Entry_x_greyscale" )

public class Entry_x_greyscale  extends HttpServlet  {

    private Workflow.RuntimeContext runtimeContext = null;
    private static final Logger log = LoggerFactory.getLogger(Entry_x_greyscale.class);
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) {
        ...
        new Workflow(runtimeContext).executeWorkflow(new xsemble.controller.n.Node_InvokeGreyScaleImage());
