...
@WebServlet(urlPatterns="/x/changeorientation", name="Entry_x_changeorientation" )

public class Entry_x_changeorientation  extends HttpServlet  {

    private Workflow.RuntimeContext runtimeContext = null;
    private static final Logger log = LoggerFactory.getLogger(Entry_x_changeorientation.class);
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) {
        ...
        new Workflow(runtimeContext).executeWorkflow(new xsemble.controller.n.Node_InvokeOrientaion());
